...
import { Typography, Card, CardContent, CardMedia, Grid, Box, IconButton } from '@mui/material';
// icons and png
		...
		<Grid container spacing={3}>
			{shoppingCart.map((product) => (
				<Grid item key={product} xs={12} sm={12} md={6} lg={6}>
					<Card className={style.card} style={{ backgroundColor: '#E9EDF0', borderRadius: '5%' }}>
						<CardMedia className={style.cardMedia} image={product.image} title="Image title" />
